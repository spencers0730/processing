...
void draw()
{
  ...
  if(update)
  {
    ...
    if(mousePressed) addCircles(1, constrain(mouseX, MAXRAD, width - MAXRAD), constrain(mouseY, MAXRAD, width - MAXRAD));
...
void mousePressed()
{
  //if(update) addCircles(100);//, constrain(mouseX, MAXRAD, width - MAXRAD), constrain(mouseY, MAXRAD, width - MAXRAD));
}
